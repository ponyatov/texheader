...
% %% Alcatel OneTouch Pixi 4007D 
% \usepackage[paperwidth=146mm,paperheight=85mm,margin=2mm]{geometry}
%% screen paper layout (A5 landscape)
%\usepackage[paperwidth=145mm,paperheight=210mm,margin=5mm]{geometry}
...
\newcommand{\termdef}[2]{\textbf{\textit{#1}}\index{#2}}
